...
//Objetivo:Imprime uma string centralizada no texto de acordo com a posiÁ„o desejada;
//Entrada: Recebe o endereco de uma string, posiÁ„o 'Y';
//Retorno: Nulo;
void imprimeCentralizado(char *texto,int y){
	//Varivaies
...
//Objetivo:	ConfiguraÁıes basicas da tela de tamanho e cor
//Entrada:	NULO; 
//SaÌda: 	NULO;
void configTela()
{
	//Tamanho da tela
	COORD outbuff;												//estrutura que define as coordenadas de uma cÈlula de caracteres em um buffer de tela do console(x e y)
	...
	SetConsoleWindowInfo(hConsole, TRUE, &windowSize);  	  	/*Define o tamanho atual e posiÁ„o da JANELA de um buffer de tela do console: 
