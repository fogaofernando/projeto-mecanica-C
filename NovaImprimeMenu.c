...
int main(){
	...
	//Variaveis
	char testeC[20],menuPrincipal[4][NOME_OPCOES],menuProprietario[2][NOME_OPCOES];
	int opMenu, teste;
	float testeF;
...
//	strcpy(menuProprietario[2],"3-Excluir ");
	...
	do{	
		...
		if(opMenu==1){
			opMenu = menu(2,menuProprietario,"Proprietario");
			
			if(opMenu == 1){
				
				leValidaInt("Informe um numero inteiro:\n>","ERRO:Nao foi possivel ler um numero inteiro...\n",0,10,&teste);
