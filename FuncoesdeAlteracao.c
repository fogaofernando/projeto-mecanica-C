...
void alteraVeiculo(int qtdeCadastros,Veiculo *veic,char *topo)
{
	...
	if(opMenu==1){
		 AlteraDado(qtdeCadastros,"Informe a Placa para Pesquisa : ","Placas encontradas","Informe a nova placa : ",veic->placa,"Alterar",">>>Erro: Placa não Encontrada...",">>>ERRO: Insira uma placa valida...",MIN_PLACA,TAM_PLACA);
		/*
